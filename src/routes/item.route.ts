...
router.put('/items/:id', authenticate, authorizedAdmin, uploadItemImages, itemController.updateItem);

router.delete('/items/:id', authenticate, authorizedAdmin, itemController.deleteItem);
